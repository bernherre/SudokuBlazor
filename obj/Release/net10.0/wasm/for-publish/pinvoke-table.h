...
wasm_native_to_interp_System_Private_CoreLib_System_Threading_ThreadPool_BackgroundJobHandler () {
    ...
    if (!(InterpEntry_T0)wasm_native_to_interp_ftndescs [0].func) {
        mono_wasm_marshal_get_managed_wrapper ("System.Private.CoreLib", "System.Threading", "ThreadPool", "BackgroundJobHandler", 100670670, 0);
    }
...
wasm_native_to_interp_System_Private_CoreLib_System_Globalization_CalendarData_EnumCalendarInfoCallback (void * arg0, void * arg1) {
    ...
    if (!(InterpEntry_T1)wasm_native_to_interp_ftndescs [1].func) {
        mono_wasm_marshal_get_managed_wrapper ("System.Private.CoreLib", "System.Globalization", "CalendarData", "EnumCalendarInfoCallback", 100668959, 2);
    }
...
wasm_native_to_interp_System_Private_CoreLib_System_Threading_TimerQueue_TimerHandler () {
    ...
    if (!(InterpEntry_T3)wasm_native_to_interp_ftndescs [3].func) {
        mono_wasm_marshal_get_managed_wrapper ("System.Private.CoreLib", "System.Threading", "TimerQueue", "TimerHandler", 100670696, 0);
    }
...
static UnmanagedExport wasm_native_to_interp_table[] = {
    {"BackgroundJobHandler#0:System.Private.CoreLib:System.Threading:ThreadPool", 100670670, wasm_native_to_interp_System_Private_CoreLib_System_Threading_ThreadPool_BackgroundJobHandler},
    {"EnumCalendarInfoCallback#2:System.Private.CoreLib:System.Globalization:CalendarData", 100668959, wasm_native_to_interp_System_Private_CoreLib_System_Globalization_CalendarData_EnumCalendarInfoCallback},
    ...
    {"TimerHandler#0:System.Private.CoreLib:System.Threading:TimerQueue", 100670696, wasm_native_to_interp_System_Private_CoreLib_System_Threading_TimerQueue_TimerHandler}
};
